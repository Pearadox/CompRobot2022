...
public class Util {
  ...
  private static double[]
      currentValues /* = new double[number]*/; // Let number be the number of terms you want to
  // average

  private static int count = 0;
  private static int total = 0;
  // public static double movingAvgCurrent(Talon motor) {
  ...
  // 	return (Robot.s_robot_state == Robot.RobotState.DISABLED && RobotController.getInputVoltage()
  // < RobotConstants.minBatteryVoltage);
  // }
